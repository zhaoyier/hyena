...
*/
ChatService.prototype.add = function(uid, playerName, channelName, serverId) {
	...
	addRecord(this, uid, playerName, serverId, channelName);
...
// 	var _connector = dispatcher.dispatch(uid, app.getServersByType('connector'));
// 	if (!_connector) {
